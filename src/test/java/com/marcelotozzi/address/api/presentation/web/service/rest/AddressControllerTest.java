...
public class AddressControllerTest {
    ...
    public void itShouldNotCreateANewAddressToUser() throws Exception {
        ...
        mvc.perform(post("/addresses").contentType(MediaType.APPLICATION_JSON_VALUE).content(json))
                .andExpect(status().isBadRequest())
    ...
    public void itShouldUpdateAnAddress() throws Exception {
        ...
        mvc.perform(put("/addresses/12").contentType(MediaType.APPLICATION_JSON_VALUE).content(json))
                .andExpect(status().isOk())
                .andExpect(content().string(""));
    }
